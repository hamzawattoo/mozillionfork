...
<template> 
  <nav class="border-b bg-blue sticky top-0 z-50">
    <div class="flex items-center lg:items-baseline justify-between px-6 py-2">
      <div
        class="flex flex-col items-baseline justify-between lg:flex-row xl:gap-12"
      >
        <div class="flex flex-col xl:flex-row items-baseline xl:gap-6">
          <div class="">
        ...
        <div class="hidden lg:flex text-sm xl:text-lg font-thin text-white whitespace-nowrap ">
        ...
        <div class="flex items-center  text-white">
          ...
          <div class="hidden xl:block">
            <div>
                <svg class="" role="img" aria-labelledby="trustpilotLogo-1v5gi0h4n2z" viewBox="0 0 126 31" xmlns="http://www.w3.org/2000/svg" style=" height: 10%; width: 80px; left: 0; top: 0;">
                  <title style="color: white;" id="trustpilotLogo-1v5gi0h4n2z">Trustpilot</title>
    ...
    <div>
    <!-- Button to open/close mobile navigation -->
    <button @click="toggleMobileNav" class="block md:hidden">
      <svg
        class="w-6 h-6"
        fill="none"
    ...
    <MobileNav :open="open" @toggle-mobile-nav="toggleMobileNav" />

    <!-- Your other content (desktop navigation, main content, etc.) -->
  </div>
  </nav>
</template>
<script>
