<script setup>
// import image
import covered from "../../images/covered_jkazef.svg";
import inspected from "../../images/inspected_sw2mlm.svg";
import secured from "../../images/secured_cu5u9x.svg";
import globe from "../../images/globe_full_nczeby.webp";
      ...
      <div class="flex px-5 py-4 mx-auto space-x-5 bg-white md:max-w-[1400px]">
        <div class="items-center hidden md:w-80 lg:flex">
          ...
          <div class="md:w-50 md:pl-5 hm-text">
            ...
            <p class="text-sm text-gray-500">24-months’ warranty, free</p>
          </div>
        </div>
        <div class="items-center hidden md:w-80 lg:flex">
          ...
          <div class="md:w-50 md:pl-3 hm-text">
            ...
            <p class="text-sm text-gray-500">
              The merciless Mozillion 90-point check
            </p>
          </div>
        </div>
        <div class="w-[50%] md:w-80 flex items-center justify-center">
          <a
            id="profile-link"
            target="_blank"
            href="https://uk.trustpilot.com/review/mozillion.com?utm_medium=trustbox&amp;utm_source=Mini"
            ><!-- Logo -->
              ...
              <div class="">
                <div
                  style="
                    ...
                    height: 0px;
                    width: 100%;
                    padding: 0px 0px 24.6032%;
                  "
                >
                  <svg
                    role="img"
                    aria-labelledby="trustpilotLogo-59wxakbfpho"
                    viewBox="0 0 126 31"
                    ...
                    "
                  >
                    <title id="trustpilotLogo-59wxakbfpho">Trustpilot</title>
                    <path
                      class="tp-logo__text"
            ...
            <!-- Stars -->
            <div class="mt-1 tp-widget-stars" id="tp-widget-stars">
              <div class="">
                <div class="">
                  <div
                    style="
                      ...
                      height: 0px;
                      width: 100%;
                      padding: 0px 0px 18.3267%;
                    "
                  >
                    <svg
                      role="img"
                      aria-labelledby="starRating-gzqn2btba87"
                      viewBox="0 0 251 46"
                      xmlns="http://www.w3.org/2000/svg"
                      style="
                        position: absolute;
        ...
        <div class="items-center hidden md:w-80 lg:flex">
          ...
          <div class="md:w-50 md:pl-5 hm-text">
            ...
            <p class="text-sm text-gray-500">30-day no quibbles</p>
          </div>
        </div>
        <div class="items-center hidden md:w-80 lg:flex">
          <div class="max-w-[80px] max-h-[80px] w-full">
          ...
          <div class="md:w-50 md:pl-5 hm-text">
            ...
            <p class="text-sm text-gray-500">
              Refurbished phones help our planet
            </p>
          </div>
        </div>
