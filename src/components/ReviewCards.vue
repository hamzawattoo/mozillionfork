...
<template>
  <div
    class="grid grid-cols-1 gap-4 px-5 mx-auto my-12 overflow-x-auto md:grid-cols-5 md:px-32 max-w-8xl"
  >
    <div class="w-48 px-4 py-4 bg-white">
      <div class="flex items-center gap-1">
        ...
        <div class="flex items-center">
          ...
          <p class="text-sm text-gray-800">Verified</p>
        </div>
      </div>
      <div class="">
